    ...
    const acaoCadastrar = async e => {
        ...
        if (editar) {
            try {
                ...
                setAlerta({ status: "success", message: "Acontecimento atualizado com sucesso" });
            } catch (err) {
            ...
            try {
                ...
                setEditar(true);
                setAlerta({ status: "success", message: "Acontecimento criado com sucesso" });
            } catch (err) {
    ...
    const remover = async (objeto) => {
        if (window.confirm("Remover este objeto?")) {
            try {
                ...
                setAlerta({ status: "success", message: "Acontecimento removido com sucesso!" });
            } catch (err) {
